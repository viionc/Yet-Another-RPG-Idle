...
const LA_HARPAR_TRADER: Record<number, DialogueProps> = {
  ...
  2: {
    message:
      'All kinds of goods. Materials, food, equipment, and any essential items you will need during your adventures.',
    options: [
      {
  ...
  10: {
    message:
      'La Harpar is the biggest fish exporter in Port Stockmar. Our fishermen are known in all four regions, aye.',
    options: [
      {
  ...
  12: {
    message:
      'Well quality of fish is obviously important, but it requires a lot of work to catch and prepare them properly.',
    options: [
      {
  ...
  16: {
    message:
      'Exploration Guild. Main rest point for local adventures. You should visit them, they can help you prepare.',
    options: [
      {
    ...
    options: [
      {
        ...
        next: 3,
        closeDialogue: true,
        specialResponse: { id: QuestIds.ratsWereRats, type: SpecialDialogueType.startsQuest },
