...
const LA_HARPAR_JOSH: Record<number, DialogueProps> = {
  ...
  1: {
    ...
    options: [
      {
        response: 'Okay, here is 20 gold coins.',
        next: 2,
        specialResponse: {
    ...
    options: [
      {
        ...
        specialResponse: {
          ...
          id: QuestIds.clearingOutTheBeach,
        },
      },
    ...
    options: [
      {
        response: 'On my way.',
        next: 2,
        nextIfQuestStarted: 13,
        specialResponse: { type: SpecialDialogueType.endsQuest, id: QuestIds.clearingOutTheBeach },
      },
    ],
  },
  6: {
    message:
      "Oi, mate. You don't want to make enemies here, you're a new face and new faces can disappear overnight here.",
    options: [
      {
      ...
      {
        response: "Don't care, you will trip over those chairs before you could catch me, bye...",
        next: 2,
        closeDialogue: true,
      },
    ],
  ...
  9: {
    message:
      'There are 4 known regions to us: Southback, Port Stocksmar, Greefic Hill and Saint Nestroud. La Harpas resides in Port Stocksmar.',
  ...
  11: {
    message:
      "Yes, no one who tried came back. Then friends or family members tried to search for those people and they also didn't come back.",
    options: [
      {
