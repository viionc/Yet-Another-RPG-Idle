...
const LA_HARPAR_ELARA: Record<number, DialogueProps> = {
  ...
  4: {
    message:
      'Captain Theron Tidecaller, was quite famous for his discoveries and uncanny ability to predict weather conditions.',
    options: [
  ...
  5: {
    ...
    options: [
      {
        response: "If I find any clues I'll let you know.",
        closeDialogue: true,
        specialResponse: { type: SpecialDialogueType.startsQuest, id: QuestIds.aTaleOfACaptain },
        next: 1,
      },
  ...
  9: {
    message:
      'Permit? Ha! Of course not, all you have to do is go to the most dangerous places and hope no one was there before.',
  ...
  16: {
    message:
      "Queen Primula, ruled over an ancient civilization called Messatan, believed to be long gone. It's probably just another fairytale.",
    options: [
