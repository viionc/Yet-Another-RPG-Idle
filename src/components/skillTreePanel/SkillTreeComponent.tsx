import { SkillTreeProps } from '../../consts/interfaces/skill-tree.interfaces'
import SkillSlot from './SkillSlot'

function SkillTreeComponent({ skillTree }: { skillTree: SkillTreeProps }) {
  return (
    <article className={`flex flex-col gap-2 items-center col-span-1 rounded-md ${skillTree.bgColor} bg-opacity-50`}>
